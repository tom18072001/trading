...
export const GLOSSARY: Record<string, string> = {
  ...
  foreign_hit_20d:
    ...
    + 'CẢNH BÁO: foreign_net đang bằng 0 trên toàn bộ lịch sử (§20.3 P0-5), nên điều kiện này chưa có tác dụng.',
  atr_pct:
  ...
  min_sessions:
    'Số phiên liên tiếp phải đạt đủ điều kiện thì mới coi là tích luỹ thật, '
    + 'không phải nhiễu một phiên. Doctrine 5; code đang chạy 3.',
  accumulation_age: 'Số phiên kể từ khi 5 điều kiện §16.1 cùng bật.',
  net_dollar_flow:
